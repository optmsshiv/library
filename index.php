...
<div class="sb">
  ...
  <div class="sb-foot">
    <div class="u-card">
      ...
      <a href="auth/logout.php" title="Logout" onclick="return confirm('Logout from the system?')" style="color:var(--ro);text-decoration:none;font-size:13px;cursor:pointer;margin-left:4px"><span class="mi sm" style="color:var(--ro)">power_settings_new</span></a>
    </div>
  </div>
</div>
