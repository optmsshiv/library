...
define('MASTER_ROOT_USER','your_cpanel_mysql_username');  // e.g. edrppymy
define('MASTER_ROOT_PASS','your_cpanel_mysql_password');  // your cPanel password
define('BASE_DOMAIN',     'yourdomain.com');              // e.g. optmstech.in
define('BASE_PATH',       '/home/yourcpaneluser/public_html'); // server path
